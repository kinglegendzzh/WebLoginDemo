...
<body>
    <div class="content" align="center">
        ...
        <div class="middle">
            <form id="loginform" action="loginaction.php" method="post">
                <table border="0">
                    ...
                    <tr>
                        <td>密&nbsp;&nbsp;&nbsp;码：</td>
                        <td><input type="password" id="password" name="password" value="<?php echo isset($_COOKIE["mima"])?$_COOKIE["mima"]:"";?>"></td>
					...
					<tr>
						<td colspan="2">
							<input type="checkbox" name="rememberpassword"><small>记住密码(7天)
						</td>
					</tr>
                    <tr>
        ...
        <!--脚部-->
        <div class="footer">
        <small>Copyright KingLegendChew &copy; 版权所有·欢迎翻版
        </div>
    </div>
</body>
</html>